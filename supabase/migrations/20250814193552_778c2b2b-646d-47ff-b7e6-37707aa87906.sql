-- Fix function to handle PostgreSQL DELETE restriction
...
BEGIN
  ...
  -- Primeiro, excluir todas as mensagens de suporte usando WHERE TRUE
  DELETE FROM support_messages WHERE TRUE;
  GET DIAGNOSTICS deleted_messages_count = ROW_COUNT;
  
  -- Depois, excluir todos os tickets usando WHERE TRUE
