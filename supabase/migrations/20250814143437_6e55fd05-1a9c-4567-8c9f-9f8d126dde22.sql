-- Inserir dados reais no sistema para demonstração
...
('Sistema de Relatórios', 'blocked', 'Temporariamente indisponível para atualizações'),
...
-- Inserir próximos lançamentos reais
...
(
  ...
  'monthly',
  true,
  '["Acesso limitado", "Suporte por email", "1 projeto"]'
),
(
  'VIP',
  'vip',
  ...
  'monthly', 
  true,
  '["Acesso completo", "Suporte prioritário", "Projetos ilimitados", "Analytics avançado"]'
),
(
  'Profissional',
  'pro',
  ...
  'monthly',
  true,
  '["Todos os recursos VIP", "API completa", "Integrações avançadas", "Suporte dedicado", "Backup prioritário"]'
)
