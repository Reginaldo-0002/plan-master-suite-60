-- Add whatsapp and purchase_source columns to profiles table if they don't exist
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS whatsapp text,
ADD COLUMN IF NOT EXISTS purchase_source text;

-- Update the get_all_users_for_admin function to include whatsapp and purchase_source
